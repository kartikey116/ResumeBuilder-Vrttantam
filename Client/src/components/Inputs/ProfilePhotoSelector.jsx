    ...
    <div className='flex justify-center mb-6 '>
        ...
        { !image || (typeof image === 'string' && image.trim() === '') ? (
            <div className='w-20 h-20 flex items-center justify-center  bg-purple-100 rounded-full cursor-pointer'>
                ...
                <button className='w-8 h-8 flex items-center justify-center bg-linear-to-r from-purple-500/85 to bg-purple-700 text-white rounded-full cursor-pointer' type="button" onClick={onChooseFile}>
                    <LuUpload/>
                </button>
            </div>
        ) :(
            <div className='relative'> 
                <img src={preview?.trim() || previewurl?.trim() || image} alt="profile photo" className=' w-20 h-20 rounded-full object-cover' />
