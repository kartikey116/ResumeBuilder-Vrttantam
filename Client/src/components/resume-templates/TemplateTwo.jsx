...
import ContactInfo from "../resume-sections/ContactInfo.jsx";
import EducationInfo from "../resume-sections/EducationInfo.jsx";
import { formatYearMonth } from "../../utils/helper.js";
import Languagesection from "../resume-sections/Languagesection.jsx";
import ProjectInfo from "../resume-sections/ProjectInfo.jsx";
import SkillSection from "../resume-sections/SkillSection.jsx";
import CertificationInfo from "../resume-sections/CertificationInfo.jsx";
import WorkExperience from "../resume-sections/WorkExperience.jsx";
  ...
  return (
    ...
    >
      <div className="flex items-start gap-5 px-2 mb-5">
        <div className="w-[100px] h-[100px] max-w-[105px] max-h-[105px] rounded-2xl items-center justify-center" style={{ backgroundColor: themeColors[1] }}>
              ...
              {resumeData.education && resumeData.education.length > 0 ? (
                resumeData.education.map((data, index) => (
                  <EducationInfo
                    ...
                    duration={`${formatYearMonth(data.startDate) || "N/A"} - ${
                      formatYearMonth(data.endDate) || "N/A"
                    }`}
                  />
                ))
              ) : (
