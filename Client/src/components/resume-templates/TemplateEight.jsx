                     ...
                     <section style={styles.section}>
                        <h2 style={styles.sectionTitle}>Technical Skills</h2>
                         <div style={styles.skillsContainer}>
                            {Object.entries(groupedSkills).map(([cat, items], idx) => (
                                <p key={idx} style={styles.skillItem} className="print-safe-section">
                                    <strong style={{fontWeight: 'bold'}}>{cat}: </strong>
                                    {items.join(', ')}
                                </p>
                            ))}
                        </div>
                 ...
                 {education.length > 0 && (
                    <section style={styles.section}>
                        ...
                        {education.map((edu, index) => (
                            <div key={index} style={{ marginBottom: '15px' }} className="print-safe-section">
                ...
                {certifications.length > 0 && (
                    <section style={styles.section}>
                        ...
                        {certifications.map((cert, index) => (
                            <div key={index} style={{ marginBottom: '14px' }} className="print-safe-section">
